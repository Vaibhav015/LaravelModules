        ...
        <div class="step well">
            <form data-parsley-validate="">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName2" placeholder="Name of Event" required="">
              </div>
              <div class="form-group">
                <label for="address">Address of Event</label>
                <input type="text" class="form-control" id="autocomplete" placeholder="Enter your address"onFocus="geolocate()" required="">
              </div>
              <div class="form-group">
