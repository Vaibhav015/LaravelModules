      ...
      <div class="col-md-8 col-md-offset-2">    
        ...
        <div class="step well">
            <form>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName2" placeholder="Name of Event">
              </div>
              <div class="form-group">
        ...
        <form>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName2" placeholder="Event Type">
              </div>
              <div class="form-group">
